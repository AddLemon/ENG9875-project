...
def read_evaluation_file(file_num):
    if file_num == 1:
        fd = open("FCFS_turnaroundTime.txt", "r")
    elif file_num == 2:
        fd = open("HRRN_turnaroundTime.txt", "r")
    elif file_num == 3:
        fd = open("SJF_turnaroundTime.txt", "r")
    elif file_num == 4:
        fd = open("STCF_turnaroundTime.txt", "r")
    else:
...
def aTime_short():
    ...
    plt.xlabel("ratio / *10%")
    plt.savefig("turnaroundTime_all_aTime_short.png")
    plt.clf()
    print("ok")
...
def nTime_short():
    ...
    plt.ylabel("Turnaround Time")
    plt.xlabel("ratio / *10%")
    plt.savefig("turnaroundTime_all_nTime_short.png")
    plt.clf()
    print("ok")
...
def nTime_long():
    ...
    plt.ylabel("Turnaround Time")
    plt.xlabel("ratio / *10%")
    plt.savefig("turnaroundTime_all_nTime_long.png")
    plt.clf()
    print("ok")
